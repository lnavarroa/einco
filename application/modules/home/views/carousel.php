  ...
  <div class="col-md-12">
    <div id="eincocarousel" class="carousel slide" data-ride="carousel"><!-- class of slide for animation -->
      <ol class="carousel-indicators">
                ...
                <li data-target="#eincocarousel" data-slide-to="2"></li>
            </ol>
      <div class="carousel-inner">
        <div class="container text-center">
            <h1 class="display-4 mb-4">EINCO Soluciones.</h1>
        <p class="lead"></p>
          
        </div><br>
        <div class="carousel-item active">
            <div class="container text-center">
                <h2 class="display-4 mb-4">Ingeniería Civil.</h2>
          </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="container text-center">
                <h2 class="display-4 mb-4">Obras.</h2>
          </div>
        </div>
        <div class="carousel-item">
            <div class="container text-center">
